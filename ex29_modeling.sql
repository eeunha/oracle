...
/*
	...
	4. 관계 정의
 	...
 	정규화, Normalization
 	- 자료의 손실이나 불필요한 정보를 없애고, 데이터의 일관성을 유지하며, 데이터 종속성을 최소화해준다.
 	...
 	2. 갱신 이상, Update Anomaly
 		- 동일한 데이터가 2개 이상의 테이블에 동시 저장
 			> 그 중 1개는 수정했지만, 다른 1개를 수정 못 하면, 둘 중 어느 것이 올바른 데이터인지 판단하지 못하는 상황
 	...
 	1. 완전 함수 종속 -- 기본키가 아닌 컬럼이 기본키에게 종속적인 상태
 	2. 부분 함수 종속
 	3. 이행 함수 종속
