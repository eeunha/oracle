...
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'범죄도시2',TO_DATE('2022-05-18','YYYY-MM-DD'),'106분',8,null,null,12693415,'42회 황금촬영상, 2022','15세이상관람가','이상용','“느낌 오지? 이 놈 잡아야 하는 거”                                 
가리봉동 소탕작전 후 4년 뒤,                                 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'탑건: 매버릭',TO_DATE('2022-06-22','YYYY-MM-DD'),'130분',9.3,null,null,8197326,'31회 MTV 영화 & TV 상, 2023','12세이상 관람가','조셉 코신스키','한순간의 실수도 용납되지 않는 하늘 위,  
가장 압도적인 비행이 시작된다! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'아바타:물의 길',TO_DATE('2022-12-14','YYYY-MM-DD'),'192분',7.8,null,null,10805065,'95회 아카데미시상식, 2023','12세이상관람가','제임스 카메론','<아바타: 물의 길>은 판도라 행성에서  
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'한산: 용의 출현',TO_DATE('2022-07-27','YYYY-MM-DD'),'130분',8.5,null,null,7265209,'59회 백상예술대상, 2023','12세이상관람가','김한민','나라의 운명을 바꿀 압도적 승리의 전투가 시작된다! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'공조2: 인터내셔날',TO_DATE('2022-09-07','YYYY-MM-DD'),'129분',7.4,null,'1개',6982940,'58회 대종상영화제, 2022','15세이상관람가','이석훈','공조 이즈 백! 이번엔 삼각 공조다! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'닥터 스트레인지: 대혼돈의 멀티버스',TO_DATE('2022-05-04','YYYY-MM-DD'),'126분',6.7,null,'2개',5884595,'31회 MTV 영화 & TV 상, 2023','12세이상관람가','샘 레이비','지금껏 본 적 없는 마블의 극한 상상력! 
5월, 광기의 멀티버스가 깨어난다! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'헌트',TO_DATE('2022-08-10','YYYY-MM-DD'),'125분',8.8,null,null,4352513,'59회 백상예술대상, 2023','15세이상관람가','이정재','조직 내 숨어든 스파이를 색출하라!  
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'올빼미',TO_DATE('2022-11-23','YYYY-MM-DD'),'118분',8.8,null,null,3329634,'59회 백상예술대상, 2023','15세이상관람가','안태진','맹인이지만 뛰어난 침술 실력을 지닌 ‘경수’는 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'쥬라기 월드: 도미니언',TO_DATE('2022-06-01','YYYY-MM-DD'),'147분',6,null,null,2837413,null,'12세이상관람가','콜린 트레보로우','이제 모든 것이 끝난다, 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'마녀(魔女) Part2. The Other One',TO_DATE('2022-06-15','YYYY-MM-DD'),'137분',5.9,null,'1개',2806501,null,'15세이상관람가','박훈정','통제불능의 존재가 세상 밖으로 나왔다! 
‘자윤’이 사라진 뒤, 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'토르: 러브 앤 썬더',TO_DATE('2022-07-06','YYYY-MM-DD'),'119분',5,null,'2개',2716306,null,'12세이상관람가','타이카 와이티티','신을 죽이는 자, 신이 상대한다! 
슈퍼 히어로 시절이여, 안녕! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'미니언즈2',TO_DATE('2022-07-20','YYYY-MM-DD'),'87분',6.6,null,'1개',2269033,null,'전체관람가','카일 발다','오랜마니언! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'블랙 팬서: 와칸다 포에버',TO_DATE('2022-11-09','YYYY-MM-DD'),'161분',5.7,null,'1개',2105988,'95회 아카데미시상식, 2023','12세이상관람가','라이언 쿠글러','“와칸다를 지켜라!” 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'비상선언',TO_DATE('2022-08-03','YYYY-MM-DD'),'140분',6.2,null,null,2058869,'16회 아시아필름어워즈, 2023','12세이상관람가','한재림','‘비상선언’: 재난 상황에 직면한 항공기가 더 이상 정상적인 운항이 불가능하여, 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'스파이더맨: 노 웨이 홈',TO_DATE('2021-12-15','YYYY-MM-DD'),'148분',6.7,'2022.10.05','2개',7551990,'30회 MTV 영화 & TV 상, 2022','12세이상관람가','존 왓츠','‘미스테리오’의 계략으로 세상에 정체가 탄로난
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'육사오(6/45)',TO_DATE('2022-08-24','YYYY-MM-DD'),'113분',8.1,null,'1개',1981014,'59회 백상예술대상, 2023','12세이상관람가','박규태','“45개 번호 중에 6개 맞히면 1등인 육사오라는 종이쪼가리, 
내가 주웠지 말입니다” 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'헤어질 결심',TO_DATE('2022-06-29','YYYY-MM-DD'),'138분',7.7,null,null,1898785,'59회 백상예술대상, 2023','15세이상관람가','박찬욱','산 정상에서 추락한 한 남자의 변사 사건. 
담당 형사 `해준`(박해일)은 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'외계+인 1부',TO_DATE('2022-07-20','YYYY-MM-DD'),'142분',7.1,null,'1개',1539364,'42회 황금촬영상, 2022','12세이상관람가','최동훈','“아주 오래전부터 외계인은 그들의 죄수를 
인간의 몸에 가두어 왔다”  
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'영웅',TO_DATE('2022-12-21','YYYY-MM-DD'),'120분',9.2,null,null,3273771,null,'12세이상관람가','윤제균','어머니 ‘조마리아’(나문희)와 가족들을 남겨둔 채 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'해적: 도깨비 깃발 ',TO_DATE('2022-01-26','YYYY-MM-DD'),'125분',5.4,null,null,1339242,null,'12세이상관람가','김정훈','“가자, 보물 찾으러!”  
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'브로커',TO_DATE('2022-06-08','YYYY-MM-DD'),'129분',6,null,null,1261131,'16회 아시아필름어워즈, 2023','12세이상관람가','고레에다 히로카즈','세탁소를 운영하지만 늘 빚에 시달리는 `상현`(송강호)과 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'신비한 동물들과 덤블도어의 비밀 ',TO_DATE('2022-04-13','YYYY-MM-DD'),'142분',6.1,null,null,1195443,null,'12세이상관람가','데이빗 예이츠','가장 위험한 마법에 맞선, 세상을 구할 전쟁이 시작된다! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'인생은 아름다워',TO_DATE('2022-09-28','YYYY-MM-DD'),'122분',8.9,null,null,1172016,'58회 대종상영화제, 2022','12세이상관람가','최국희','내 생애 가장 빛나는 선물 
모든 순간이 노래가 된다! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'더 배트맨',TO_DATE('2022-03-01','YYYY-MM-DD'),'176분',6.5,null,'1개',906659,'21회 워싱턴비평가협회상, 2022','15세이상관람가','매트 리브스','영웅이 될 것인가 악당이 될 것인가 
운명을 결정할 선택만이 남았다 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'데시벨',TO_DATE('2022-11-06','YYYY-MM-DD'),'110분',6.5,null,'1개',901426,null,'12세이상관람가','황인호','소음이 커지는 순간 폭.발.한.다 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'정직한 후보2',TO_DATE('2022-09-28','YYYY-MM-DD'),'107분',3.4,null,'1개',899899,null,'12세이상관람가','장유정','거짓말 못하는 ‘진실의 주둥이’ 컴백! 이번엔 2명?!  
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'씽2게더',TO_DATE('2022-01-05','YYYY-MM-DD'),'110분',8.8,null,null,885578,null,'전체관람가','가스 제닝스','전 세계가 주목한 스테이지! 함께 도전할 준비됐지? 대국민 오디션 이후 각자의 자리에서 꿈을 이루고 있는 버스터 문(매튜 맥커너히)과 크루들에게 레드 쇼어 시티에서 전 세계가 주목하는 사상 최고의 쇼가 펼쳐진다는 소식이 들려오고 버스터 문과 크루들은 도전에 나선다. 그러나 최고의 스테이지에 서기 위한 경쟁은 이전과는 비교도 할 수 없을 만큼 치열하고, 버스터 문은 완벽한 라이브를 위해 종적을 감춘 레전드 뮤지션 클레이(보노)를 캐스팅하겠다는 파격 선언을 하는데!');

INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'극장판 짱구는 못말려: 수수께끼! 꽃피는 천하떡잎학교',TO_DATE('2022-09-28','YYYY-MM-DD'),'104분',8.5,null,null,837647,null,'전체관람가','타카하시 와타루','짱구와 친구들, 명문학교에 입학하다?!  
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'블랙아담',TO_DATE('2022-10-19','YYYY-MM-DD'),'125분',6.7,null,'1개',779489,null,'15세이상관람가','자움 콜렛 세라','누구도 막을 수 없다! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'킹메이커',TO_DATE('2022-01-26','YYYY-MM-DD'),'123분',8.2,null,null,783567,'42회 황금촬영상, 2022','15세이상관람가','변성현','세상을 바꾸기 위해 도전하는 정치인 ‘김운범’ 앞에 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'자백',TO_DATE('2022-10-26','YYYY-MM-DD'),'105분',7.5,null,null,738122,'42회 판타스포르토국제영화제, 2022','15세이상관람가','윤종석','제대로 함정에 빠졌다! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'언차티드',TO_DATE('2022-02-16','YYYY-MM-DD'),'116분',6.3,null,'2개',730847,null,'12세이상관람가','루벤 플레셔','모든 것을 걸었다면 세상 누구보다 빠르게 찾아야 한다!  
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'경관의 피',TO_DATE('2022-01-05','YYYY-MM-DD'),'119분',6.5,null,null,684667,null,'15세이상관람가','이규만','경찰의 기준이 뒤집어진다! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'오늘 밤, 세계에서 이 사랑이 사라진다 해도',TO_DATE('2022-11-30','YYYY-MM-DD'),'121분',7,null,null,1100688,'46회 일본아카데미상, 2023','12세이상관람가','미키 타카히로','“카미야 토루에 대해 잊지 말 것” 
자고 일어나면 전날의 기억을 잃는 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'극장판 주술회전 0',TO_DATE('2022-02-17','YYYY-MM-DD'),'105분',7.4,null,'1개',664565,null,'15세이상관람가','박성후','어릴 적 소꿉친구인 오리모토 리카를 교통사고로 눈앞에서 잃은 옷코츠 유타. 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'압꾸정',TO_DATE('2022-11-30','YYYY-MM-DD'),'112분',4.6,null,'1개',608639,null,'12세이상관람가','임진순','“나한테 죽이는 아이디어가 있어. 대한민국에서 한 번도 시도 안 했던 거” 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'극장판 포켓몬스터DP: 기라티나와 하늘의 꽃다발 쉐이미',TO_DATE('2022-06-01','YYYY-MM-DD'),'96분',8.1,null,null,581223,null,'전체관람가','유야마 쿠니히코','끝나지 않은 전설의 포켓몬들의 배틀로 
위험에 빠진 반전 세계와 현실 세계를 구하기 위해 
감사포켓몬 `쉐이미`와 `지우`, `피카츄`가 나서면서 시작되는 모험 이야기');

INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'이상한 나라의 수학자 ',TO_DATE('2022-03-09','YYYY-MM-DD'),'117분',8.4,null,null,534291,null,'12세이상관람가','박동훈','“정답보다 중요한 건 답을 찾는 과정이야”  
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'명탐정 코난: 할로윈의 신부 ',TO_DATE('2022-07-13','YYYY-MM-DD'),'110분',8.3,null,null,490869,null,'12세이상관람가','미츠나카 스스무','트리플 페이스 아무로 토오루, 그의 목에 폭탄이 채워졌다?! 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'동감',TO_DATE('2022-11-16','YYYY-MM-DD'),'114분',5.9,null,null,490145,null,'12세이상관람가','서은영','1999년, 용은 첫눈에 반하게 된 한솔을 사로잡기 위해 
친구에게 HAM 무전기를 빌린다. 
2022년, ‘무늬’는 인터뷰 과제를 위해 
오래된 HAM 무전기를 작동시킨다. 
씨큐... 씨큐... 제 목소리 들리세요? 
개기 월식이 일어난 날,
시간을 뛰어넘어 기적처럼 연결된 용과 무늬는
서로의 사랑과 우정을 이야기하며 특별한 감정을 쌓아가는데... 
1999 - 2022 마음을 수신합니다.');

INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'모비우스',TO_DATE('2022-03-30','YYYY-MM-DD'),'104분',6.2,null,'2개', 475928,'43회 골든라즈베리시상식, 2023','15세이상관람가','대니얼 에스피노사','구원자인가, 파괴자인가 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'늑대사냥',TO_DATE('2022-09-21','YYYY-MM-DD'),'121분',6.1,null,null,468720,'55회 시체스국제판타스틱영화제, 2022','청소년관람불가','김홍선','인간 스스로 먹잇감이 되다 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'뽀로로 극장판 드래곤캐슬 대모험 ',TO_DATE('2022-07-28','YYYY-MM-DD'),'70분',7.8,null,null,450934,'26회 부천국제판타스틱영화제, 2022','전체관람가','강승훈','깊은 산속 드래곤캐슬에 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'특송',TO_DATE('2022-01-12','YYYY-MM-DD'),'108분',6.9,null,null,444417,'42회 황금촬영상, 2022','15세이상관람가','박대민','2022년을 여는 가장 짜릿한 범죄 오락 1,의 탄생!  
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'니 부모 얼굴이 보고 싶다',TO_DATE('2022-04-27','YYYY-MM-DD'),'111분',7,null,null,416524,null,'15세이상관람가','김지훈','“누군가 잘못했겠지 
하지만 내 아들은 절대 아니야” 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'놉',TO_DATE('2022-08-17','YYYY-MM-DD'),'130분',6,null,null,416048,'88회 뉴욕비평가협회상, 2022','12세이상관람가','조던 필','그것은 우리 위에 있다. 
거대하고, 주목받길 원하고, 미쳤다. 나쁜 기적이라는 것도 있을까?');

INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'리멤버',TO_DATE('2022-10-26','YYYY-MM-DD'),'128분',9.1,null,null,412836,null,'15세이상관람가','이일형','“부서진 차… 손에 묻은 피… 권총 한 자루… 내가 왜 여기에 있는 거지?” 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'킹스맨: 퍼스트 에이전트',TO_DATE('2021-12-22','YYYY-MM-DD'),'131분',7,null,'1개',1029365,null,'청소년관람불가','매튜 본','역사상 최악의 폭군들과 범죄자들이 모여 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'배드 가이즈',TO_DATE('2022-05-04','YYYY-MM-DD'),'100분',8,null,null,400329,null,'전체관람가','피에르 페리펠','드림웍스 최초의 범죄오락1, 블록버스터! 
어디 착한 짓 좀 해볼까? 
...
INSERT INTO mtblmovie (MOVIE_Seq, name, releaseDate, runningTime, grade, reOpening, cookie, cumulAudience, Awards, rating, director, detail)
VALUES ((SELECT nvl(max(MOVIE_Seq), 0) + 1 FROM mTBLMOVIE),'뜨거운 피',TO_DATE('2022-03-23','YYYY-MM-DD'),'120분',6.2,'2022.05.26',null,398105,'58회 백상예술대상, 2022','15세이상관람가','천명관','부산 변두리 작은 포구 `구암`의 절대적인 주인 `손영감`(김갑수), 
