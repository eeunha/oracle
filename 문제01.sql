...
SELECT * FROM TBLINSA WHERE BASICPAY >= (20000000 / 12) AND CITY = '서울' AND JIKWI IN ('과장', '부장');
...
--요구사항.021.tblInsa
--남자 직원만 가져오시오.
SELECT * FROM TBLINSA WHERE SSN LIKE '______-1______'; -- '%-1%'


-- 요구사항.022.tblInsa
--여자 직원만 가져오시오.   
SELECT * FROM TBLINSA WHERE SSN LIKE '______-2______'; -- '%-2%'


--요구사항.023.tblInsa
--여름에(7,8,9월) 태어난 직원들 가져오시오.
SELECT * FROM TBLINSA WHERE SSN LIKE '__07__________' OR SSN LIKE '__08__________' OR SSN LIKE '__09__________'; -- '__07%' 도 가능
...
SELECT * FROM TBLINSA WHERE CITY IN ('서울', '인천', '경기') AND IBSADATE >= '1998-01-01' AND IBSADATE <= '2000-12-31'; -- ibsadate between '1998-01-01' and '2000-12-31';
